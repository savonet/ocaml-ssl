...
type protocol =
  ...
  | TLSv1   [@ocaml.deprecated "TLSv1 is deprecated"  ] (** only TLS v1 protocol *)
  | TLSv1_1 [@ocaml.deprecated "TLSv1.1 is deprecated"] (** only TLS v1.1 protocol *)
  | TLSv1_2 [@ocaml.deprecated "TLSv1.2 is deprecated"] (** only TLS v1.2 protocol *)
